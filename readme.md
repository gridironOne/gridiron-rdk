...
[![license](https://img.shields.io/github/license/cosmos/cosmos-sdk.svg#thumbnail)](https://github.com/gridironOne/rdk/blob/main/LICENSE)

Gridiron RDK, which stands for *RollApp Development Kit* is based on the [Cosmos SDK](https://github.com/cosmos/cosmos-sdk) framework, modified and enhanced for building autonomous RollApps (app-specific-rollups) on top of the [Gridiron Hub](https://github.com/gridironOne/gridiron).

The RDK provides the following capabilities ***on top*** of the [Cosmos SDK](https://github.com/cosmos/cosmos-sdk) framework:

* The RDK is coupled with the [Furyint](https://github.com/gridironOne/furyint) client to form RollApp's blazing speed consensus and networking layer, while ***the Gridiron Hub is securing the rollapp***
