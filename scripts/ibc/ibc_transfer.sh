...
HUB_GENESIS_ADDR=$(furyd keys show $KEY_NAME_GENESIS -a --keyring-backend test)
...
FURY_AMOUNT="$TOKENS_AMOUNT"ufury
...
usage ()
{
	...
	echo "hub2rol: ibc-transfer of $FURY_AMOUNT to $KEY_NAME_ROLLAPP from $KEY_NAME_GENESIS"
